    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          >
            <Image
              src="https://media.licdn.com/dms/image/C4E03AQHB7ZgpL8zkVQ/profile-displayphoto-shrink_400_400/0/1655610203810?e=1704326400&v=beta&t=hyXnYWngxDz9PaxY39lML89niqsM6nkEe8kQNoxxIuQ"
              alt="Febrian Photo"
              width="192"
              height="192"
              quality="95"
      ...
      >
        <span className="font-bold">Hello, I'm Febrian Bayu Nugroho.</span> I'm
